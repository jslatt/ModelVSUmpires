...
# Strike Zone LASSO
lasso1 <- gamlr(x_cat_no_sz, 	y=y_in_strike_zone, standardize=FALSE, family="binomial",
                lambda.min.ratio=1e-3)

par(mfrow=c(1,1))

plot(lasso1, main="In Strike Zone Full Model")
...
cv.lasso1 <- cv.gamlr(x_cat_no_sz, 	y=y_in_strike_zone,
...
lasso2 <- gamlr(x_cat_no_sz_desc, 	y=y_in_strike_zone, standardize=FALSE, family="binomial",
                lambda.min.ratio=1e-3)

par(mfrow=c(1,1))

plot(lasso2, main="In Strike Zone w/o Description")
...
cv.lasso2 <- cv.gamlr(x_cat_no_sz_desc, 	y=y_in_strike_zone,
                      standardize=FALSE, family="binomial", lambda.min.ratio=1e-3)
...
write.csv(lasso1_coef_df, "~/Spring 2024/Big Data/Final Project/Lasso/strike_zone/lasso1.csv")
write.csv(cv.lasso1_coef_oos_df, "~/Spring 2024/Big Data/Final Project/Lasso/strike_zone/cv.lasso1_oos.csv")
write.csv(cv.lasso1_coef_1se_df, "~/Spring 2024/Big Data/Final Project/Lasso/strike_zone/cv.lasso1_1se.csv")
write.csv(lasso2_coef_df, "~/Spring 2024/Big Data/Final Project/Lasso/strike_zone/lasso2.csv")
write.csv(cv.lasso2_coef_oos_df, "~/Spring 2024/Big Data/Final Project/Lasso/strike_zone/cv.lasso2_oos.csv")
write.csv(cv.lasso2_coef_1se_df, "~/Spring 2024/Big Data/Final Project/Lasso/strike_zone/cv.lasso2_1se.csv")
