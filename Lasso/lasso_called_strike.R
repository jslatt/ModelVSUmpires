...
# Correct Call LASSO
# Without description
lasso1 <- gamlr(x_cat_no_desc, 	y=y_called_strike, standardize=FALSE, family="binomial",
                lambda.min.ratio=1e-3)

par(mfrow=c(1,1))

plot(lasso1, main="Called Strike Full Model")
...
cv.lasso1 <- cv.gamlr(x_cat_no_desc, 	y=y_called_strike,
...
lasso2 <- gamlr(x_cat_no_sz_desc, 	y=y_called_strike, standardize=FALSE, family="binomial",
                lambda.min.ratio=1e-3)

par(mfrow=c(1,1))

plot(lasso2, main="Called Strike w/o Strike Zone")
...
cv.lasso2 <- cv.gamlr(x_cat_no_sz_desc, 	y=y_called_strike,
                      standardize=FALSE, family="binomial", lambda.min.ratio=1e-3)
...
write.csv(lasso1_coef_df, "~/Spring 2024/Big Data/Final Project/Lasso/called_strike/lasso1.csv")
write.csv(cv.lasso1_coef_oos_df, "~/Spring 2024/Big Data/Final Project/Lasso/called_strike/cv.lasso1_oos.csv")
write.csv(cv.lasso1_coef_1se_df, "~/Spring 2024/Big Data/Final Project/Lasso/called_strike/cv.lasso1_1se.csv")
write.csv(lasso2_coef_df, "~/Spring 2024/Big Data/Final Project/Lasso/called_strike/lasso2.csv")
write.csv(cv.lasso2_coef_oos_df, "~/Spring 2024/Big Data/Final Project/Lasso/called_strike/cv.lasso2_oos.csv")
write.csv(cv.lasso2_coef_1se_df, "~/Spring 2024/Big Data/Final Project/Lasso/called_strike/cv.lasso2_1se.csv")
